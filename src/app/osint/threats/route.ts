...
export async function GET(request: NextRequest) {
  ...
  // Clé effective : en-tête user `x-osiris-key-abuseipdb` OU env ABUSEIPDB_KEY
  // (voir keyOf). Règle d'or : sans aucune clé, AUCUN appel réseau.
  const key = keyOf(request, 'abuseipdb', 'ABUSEIPDB_KEY');
