...
#  - NEXT_PUBLIC_OSIRIS_FORM : '2' = poste enquêteur (couches sensibles opt-in visibles) ; défaut '1' public.
ARG NEXT_PUBLIC_OSIRIS_FORM="1"
ENV NEXT_PUBLIC_OSIRIS_FORM=$NEXT_PUBLIC_OSIRIS_FORM
RUN npm run build
